...
class DashedPercentageMeter: UIView {
    ...
    override func draw(_ rect: CGRect)
    {
        ...
        self.lineDashLayer.lineDashPattern = [2, 10]
        ...
        self.beginLayer.strokeColor = UIColor.cyan.cgColor
        ...
        percentageLabel.font = UIFont.systemFont(ofSize: 40.0, weight: UIFont.Weight.regular)
